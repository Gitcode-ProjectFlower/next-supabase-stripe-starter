...
const createSelectionSchema = z.object({
  ...
  items: z.array(
    z.object({
      ...
      sector_level1: z.string().optional(),
      sector_level2: z.string().optional(),
      sector_level3: z.string().optional(),
      region_level1: z.string().optional(),
      region_level2: z.string().optional(),
      region_level3: z.string().optional(),
      region_level4: z.string().optional(),
