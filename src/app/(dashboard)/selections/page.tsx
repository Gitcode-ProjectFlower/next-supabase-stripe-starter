        ...
        return (
            <div className="flex min-h-screen items-center justify-center">
                <div className="text-center">
                    <div className="text-lg font-medium text-gray-900">Loading selections...</div>
                </div>
            </div>
        );
    }
            ...
            <div className="flex min-h-screen items-center justify-center bg-gray-50">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-gray-600">
                        Create your first selection to save and manage candidate lists
                    </p>
                    <Button
                        className="mt-6 rounded-lg bg-blue-600 px-6 py-2 text-white hover:bg-blue-700"
                        onClick={() => router.push('/new-selection')}
                    >
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-gray-600">
                            Manage your saved candidate selections
                        </p>
                    </div>
                    <Button
