            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={detailsBox}>
                        ...
                        <Text style={detail}>
                            <strong>Amount:</strong> {currencySymbol}{formattedAmount} / {interval}
                        </Text>
                        <Text style={detail}>
                    ...
                    <Text style={text}>
                        If you didn&apos;t subscribe to this plan, please contact our support team immediately. don&apos;t hesitate to contact our support team.
                    </Text>
