...
import { createMockUser, createMockHaystackResponse, createMockFetchResponse } from '@/__tests__/utils/test-helpers';
...
describe('Integration: Search Flow', () => {
    ...
    beforeEach(() => {
        ...
        (global.fetch as any).mockResolvedValue(
            createMockFetchResponse(createMockHaystackResponse(10))
        );
    });
