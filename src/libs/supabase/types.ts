  ...
  public: {
    Tables: {
      ...
      qa_standard_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "qa_standard_runs_selection_id_fkey"
            columns: ["selection_id"]
            isOneToOne: false
            referencedRelation: "selections"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "qa_standard_runs_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "qa_sessions"
            referencedColumns: ["id"]
      ...
      selection_items: {
        Row: {
          ...
          sector_level1: string | null
          sector_level2: string | null
          sector_level3: string | null
          sectors: Json | null
          selection_id: string
    ...
    Functions: {
      ...
      update_selection_items: {
        Args: { p_items: Json; p_selection_id: string }
        Returns: undefined
      }
    }
    Enums: {
